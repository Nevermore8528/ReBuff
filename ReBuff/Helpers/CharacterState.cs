...
namespace ReBuff.Helpers
{
    public class CharacterState
    {
        ...
        public static Job GetPartyJob(int i)
        {
            PartyMember? partymember = Singletons.PartyList[i];
            ...
            unsafe
            {
                return (Job)((Character*)partymember.Address)->ClassJob;
            }
        }
        ...
        public static bool IsJobType(Job job, JobType type, IEnumerable<Job>? jobList = null) => type switch
        {
            ...
            JobType.Ranged_Card => IsJobType(job, JobType.Casters) || IsJobType(job, JobType.Healers) || IsJobType(job, JobType.Ranged),
            JobType.Melee_Card => IsJobType(job, JobType.Tanks) || IsJobType(job, JobType.Melee),
            _                => false
        };
    }
}
