...
namespace ReBuff
{
    ...
    {
        public const string ConfigFileName = "ReBuff.json";

        public static string Version { get; private set; } = "0.3.0.2";
        ...
        )
        {
            ...
            // Load config
            ReBuffConfig config = ConfigHelpers.LoadConfig(Plugin.ConfigFilePath);
        ...
        private static TextureWrap? LoadIconTexture(UiBuilder uiBuilder)
        {
            ...
            {
                PluginLog.Warning($"Failed to load ReBuff Icon {ex.ToString()}");
            }
